...
//code pour letape 3 du 4.1
  if (chapitre.img != undefined) {ShowImg.innerHTML = `<img src="assets/${chapitre.img}">`} else if (chapitre.video != undefined){ShowVideo.innerHTML = `<img src="assets/${chapitre.video}">`};
